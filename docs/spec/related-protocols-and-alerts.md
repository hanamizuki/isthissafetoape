...
- Subscription management: the `/alerts` page (Manage Alerts, reached from the header avatar menu) lists every followed protocol with one-click unfollow; the report-page bell toggles, and every email contains an unsubscribe link.
